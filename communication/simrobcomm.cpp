...
//    double rotationVel = (leftVel - rightVel) / 2;
    ...
    command->set_wheel1(-(double)leftVel/100 * 100);
    command->set_wheel2(-(double)leftVel/100 * 100);
    command->set_wheel3((double)rightVel/100 * 100);
    command->set_wheel4((double)rightVel/100 * 100);
