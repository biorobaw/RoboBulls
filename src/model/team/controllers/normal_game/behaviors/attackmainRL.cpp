...
//    }
    ...
    {   //state = passing;
        //break;
        //std::cout << "AttackMainRL: Score" << std::endl;
    ...
    case passing:
    {
        //std::cout << "AttackMainRL: Pass" << std::endl;
        robot->setDribble(true);
    ...
    case dribbling:
    {
        //std::cout << "AttackMainRL: Dribble" << std::endl;
...
void AttackMainRL::calcStaticProb()
{
...
void AttackMainRL::calcDynamicProb()
{
...
std::vector<std::vector<Point>> AttackMainRL::genClusters()
{
...
std::pair<bool, Point> AttackMainRL::calcBestGoalPoint()
{
...
std::pair<bool, Point> AttackMainRL::calcBestPassPoint()
{
...
bool AttackMainRL::isFinished()
{
    //return has_passed;
    return has_passed || has_kicked_to_goal;
}

bool AttackMainRL::hasPassed()
{
    return has_passed;
}

bool AttackMainRL::hasKickedToGoal()
{
    return has_kicked_to_goal;
}

AttackMainRL::~AttackMainRL()
{
    delete score_skill;
    delete pass_skill;
...
float AttackMainRL::getScoreProb(const Point& p)
{
