#ifndef NORMALGAMESTRATEGYTEMPLATED_H
#define NORMALGAMESTRATEGYTEMPLATED_H
...
/*! This strategy class has been revised and templated to allow for
 *  behaviors to be swapped out without having to copy/past the entire code
 *  just to change a single Behavior/Skill. Currently AttackMain and
 *  AttackSupport are supported. - Justin Rodney
 */
...
class NormalGameStrategyTemplated : public TeamStrategy
{
public:
    NormalGameStrategyTemplated(RobotTeam* _team);
...
#endif // NORMALGAMESTRATEGYTEMPLATED_H
