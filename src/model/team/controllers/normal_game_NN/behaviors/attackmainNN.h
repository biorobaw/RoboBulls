#ifndef ATTACK_MAINNN_H
#define ATTACK_MAINNN_H

#include "../../normal_game/behaviors/attackmain.h"
...
class AttackMainNN : public AttackMain//:public GenericMovementBehavior
{
public:
    AttackMainNN(Robot*);
   ~AttackMainNN();
