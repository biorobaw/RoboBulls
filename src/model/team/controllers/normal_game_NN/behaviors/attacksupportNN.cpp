...
AttackSupportNN::AttackSupportNN(Robot* robot)  : AttackSupport(robot)
{
...
AttackSupportNN::ProbNode AttackSupportNN::findMaxNode()
{
...
void AttackSupportNN::calcStaticProb()
{
...
void AttackSupportNN::calcDynamicProb()
{
...
void AttackSupportNN::genGoalShadows()
{
...
void AttackSupportNN::genDistanceFromTeammates()
{
    // Set probabilities
    for(int x = PF_LENGTH_SUPP/2; x < PF_LENGTH_SUPP; ++x)
    {
...
void AttackSupportNN::genBallShadows()
{
...
std::vector<std::vector<Point>> AttackSupportNN::genClusters()
{
...
void AttackSupportNN::genGoalShotAvoidance()
{
    auto gp = Field::getGoalPosition(OPPONENT_SIDE);
    // Top end of goal post
    float g1x = gp.x;
...
bool AttackSupportNN::isFinished()
{
    return finished;
}

string AttackSupportNN::getName() {
    return "Attack Support";
}

AttackSupportNN::~AttackSupportNN()
{
...
float AttackSupportNN::getScoreProb(const Point& p)
{
