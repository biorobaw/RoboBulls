#ifndef NORMALGAMESTRATEGYNN_H
#define NORMALGAMESTRATEGYNN_H
 ...
 * normal play.
 */
class NormalGameStrategyNN : public NormalGameStrategy
{
public:
    NormalGameStrategyNN(RobotTeam* _team);
