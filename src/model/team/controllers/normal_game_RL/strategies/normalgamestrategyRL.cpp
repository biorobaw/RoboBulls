#include "normalgamestrategyRL.h"
...
#include <QDebug>
NormalGameStrategyRL::NormalGameStrategyRL(RobotTeam* _team)
...
void NormalGameStrategyRL::assignBehaviors()
{
...
void NormalGameStrategyRL::runControlCycle()
{
...
void NormalGameStrategyRL::assignGoalieIfOk(RobotTeam* team)
{
    Robot* goalie = team->getRobotByRole(RobotRole::GOALIE);
    if(goalie)
...
QString NormalGameStrategyRL::getName(){
    return "normal game";
}

int NormalGameStrategyRL::getStatus(){
    return state;
}
