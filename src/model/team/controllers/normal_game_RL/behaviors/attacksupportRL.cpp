...
AttackSupportRL::ProbNode AttackSupportRL::findMaxNode()
{
...
void AttackSupportRL::calcStaticProb()
{
...
void AttackSupportRL::calcDynamicProb()
{
...
void AttackSupportRL::genGoalShadows()
{
...
void AttackSupportRL::genDistanceFromTeammates()
{
    // Set probabilities
    for(int x = PF_LENGTH_SUPP/2; x < PF_LENGTH_SUPP; ++x)
    {
...
void AttackSupportRL::genBallShadows()
{
...
std::vector<std::vector<Point>> AttackSupportRL::genClusters()
{
...
void AttackSupportRL::genGoalShotAvoidance()
{
    auto gp = Field::getGoalPosition(OPPONENT_SIDE);
    // Top end of goal post
    float g1x = gp.x;
...
bool AttackSupportRL::isFinished()
{
    return finished;
}

string AttackSupportRL::getName() {
    return "Attack Support";
}

AttackSupportRL::~AttackSupportRL()
{
...
float AttackSupportRL::getScoreProb(const Point& p)
{
