#ifndef DEFENDBEHAVIORRL_H
#define DEFENDBEHAVIORRL_H
#include "../../normal_game/behaviors/defendbehavior.h"
...
class DefendBehaviorRL : public DefendBehavior
{
public:
     DefendBehaviorRL(Robot*);
    ~DefendBehaviorRL();
