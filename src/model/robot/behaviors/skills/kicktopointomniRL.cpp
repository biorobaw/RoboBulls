...
//KickToPointOmniRL::KickToPointOmniRL(Robot* robot, const Point& target,
//                                 float targetTolerance, float kickDistance, bool useFullPower)
//    : KickToPointOmniRL(robot, &m_targetPoint, targetTolerance, kickDistance, useFullPower)
//{
//    m_targetPoint = target;
//}

//KickToPointOmniRL::KickToPointOmniRL(Robot* robot, Point* targetPtr,
//                                 float targetTolerance, float kickDistance, bool useFullPower)
//    : Behavior(robot)
...
//bool KickToPointOmniRL::perform()
//{
//    Point bp = *ball;
...
//            if(m_moveCompletionCount >KickToPointOmni::FORWARD_WAIT_COUNT) {
...
//bool KickToPointOmniRL::canKick(Robot* robot) {
...
//bool KickToPointOmniRL::isWithinKickDistance(Robot *robot) {
//    return m_kickDistance == -1 || Measurements::distance(robot, *m_targetPointer) < m_kickDistance;
//}

//bool KickToPointOmniRL::isCloseToBall(Robot *robot) {
...
//bool KickToPointOmniRL::isVeryFarFromBall(Robot *robot) {
//    return Measurements::distance(robot, *ball) > ROBOT_RADIUS*6;
//}

//bool KickToPointOmniRL::isFacingBall(Robot* robot) {
//    return Comparisons::isFacingPoint(robot, *ball, M_PI/3.0);
//}

//bool KickToPointOmniRL::isFacingTarget(Robot* robot) {
//    return Comparisons::isFacingPoint(robot, *m_targetPointer, m_targetTolerance);
//}

//bool KickToPointOmniRL::isInKickLock(Robot* robot)
//{
