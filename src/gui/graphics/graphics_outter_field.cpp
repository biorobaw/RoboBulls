...
{
    // default values
    setX(-5200);         // Offsets are 50% of the item's height & width
    setY(-3700);
    setZValue(0);
}

QRectF GraphicsOutterField::boundingRect() const
{
    return QRectF(0,0,10400,7400); // 3585 ~ 3600, 2585 ~ 2600
}

void GraphicsOutterField::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    (void)option;
    (void)widget;
