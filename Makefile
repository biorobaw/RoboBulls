...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Aug 18 11:07:42 2014
...
positionforkickoff.o: behavior/positionforkickoff.cpp behavior/positionforkickoff.h \
		behavior/behavior.h \
		skill/obstacleavoidmove.h \
		skill/skill.h \
		model/robot.h \
		...
		include/messages_robocup_ssl_refbox_log.pb.h \
		utilities/paramlist.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o positionforkickoff.o behavior/positionforkickoff.cpp

sendballtoregion.o: behavior/sendballtoregion.cpp behavior/sendballtoregion.h \
		behavior/behavior.h \
		skill/kicktopoint.h \
		skill/skill.h \
		model/robot.h \
		...
		utilities/region.h \
		utilities/paramlist.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sendballtoregion.o behavior/sendballtoregion.cpp

twovone.o: strategy/twovone.cpp strategy/twovone.h \
		strategy/strategy.h \
		model/gamemodel.h \
		utilities/measurments.h \
		utilities/point.h \
		...
		behavior/defendfarfromball.h \
		behavior/sendballtoregion.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o twovone.o strategy/twovone.cpp

kicktopoint.o: skill/kicktopoint.cpp skill/kicktopoint.h \
		skill/skill.h \
		model/robot.h \
		utilities/point.h \
		behavior/behavior.h \
		...
		skill/gotopositionwithorientation.h \
		skill/differential_control/closedloopcontrol.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o kicktopoint.o skill/kicktopoint.cpp

region.o: utilities/region.cpp utilities/region.h \
		utilities/point.h \
		model/gamemodel.h \
		utilities/measurments.h \
		include/globals.h \
		...
		include/netraw.h \
		include/messages_robocup_ssl_refbox_log.pb.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o region.o utilities/region.cpp
